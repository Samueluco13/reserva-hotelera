...
from api.service.reservation import create_reservation_user, create_reservation_staff, get_res_by_id, get_all_res, update_res, update_res_status, delete_res
...
async def update_reservation_status(reservation_id: int, new_status: StatusEnum, res_repo: reservation_repo, noti_repo: notification_repo, user_repo: user_repo):
