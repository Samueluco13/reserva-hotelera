...
from api.service.reservation import create_reservation_guest, create_reservation_staff, get_res_by_id, get_all_res, update_res, update_res_status, delete_res

from api.utils.db.dependencies import user_repo, room_repo, reservation_repo, notification_repo
from api.utils.security.dependencies import guest_user, company_user
...
async def update_reservation_status(reservation_id: int, new_status: StatusEnum, res_repo: reservation_repo, noti_repo: notification_repo, user_repo: user_repo, _: company_user):
    return update_res_status(reservation_id, new_status, res_repo, noti_repo, user_repo)
